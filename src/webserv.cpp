...
//                 if (clientFd == -1) {
//                     std::cerr << "\e[31mError accepting client connection: \e[0m" << gai_strerror(errno) << std::endl;
//                     continue;
//                 }
...
//                     std::cerr << "\e[31mError adding client socket to epoll: \e[0m" << gai_strerror(errno) << std::endl;
//                     close(clientFd);
//                     continue;
//                 }
